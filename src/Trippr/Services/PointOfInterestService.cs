...
namespace Trippr.Services
{
    ...
    {
        public static async Task<List<PointOfInterest>> GetPointsOfInterest(double distanceFilter)
        {
            ...
            List<PointOfInterest> pointsOfInterest = await PointOfInterestService.GetHmdbPointsOfInterest(location, distanceFilter);
            return pointsOfInterest.Concat(await GetKmlPointsOfInterest(location, distanceFilter)).ToList();
        }

        public static async Task<List<PointOfInterest>> GetKmlPointsOfInterest(Microsoft.Maui.Devices.Sensors.Location location, double distanceFilter)
        {
        ...
        public static async Task<List<PointOfInterest>> GetHmdbPointsOfInterest(Microsoft.Maui.Devices.Sensors.Location location, double distanceFilter)
        {
